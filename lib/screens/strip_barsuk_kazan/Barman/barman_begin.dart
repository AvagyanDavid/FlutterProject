...
class _barman_beginState extends State<barman_begin> {
  ...
  void getStatusReport() async {
    ...
    if (results != null) {
      ...
      commentDirectorOpenCheckout = response ['CommentDirector_OpenCheckout'];
      ...
      commentDirectorCheckAndTakeAlcogol = response ['CommentDirector_CheckAndTakeAlcogol'];
      extractorHumidifier = response['ExtractorHumidifier'] != 0 ? true : false;
      commentExtractorHumidifier.text = response ['Comment_ExtractorHumidifier'];
      commentDirectorExtractorHumidifier = response ['CommentDirector_ExtractorHumidifier'];
      writeStopList = response['WriteStopList'] != 0 ? true : false;
      commentWriteStopList.text = response ['Comment_WriteStopList'];
      commentDirectorWriteStopList = response ['CommentDirector_WriteStopList'];
      rubTheDishes = response['RubTheDishes'] != 0 ? true : false;
      commentRubTheDishes.text = response ['Comment_RubTheDishes'];
      commentDirectorRubTheDishes = response ['CommentDirector_RubTheDishes'];
      cleaning = response['Cleaning'] != 0 ? true : false;
      commentCleaning.text = response ['Comment_Cleaning'];
      commentDirectorCleaning = response ['CommentDirector_Cleaning'];
